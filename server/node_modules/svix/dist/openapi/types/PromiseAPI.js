...
class PromiseMessageAttemptApi {
    ...
    v1MessageAttemptListByEndpoint(appId, endpointId, limit, iterator, status, statusCodeClass, channel, before, after, withContent, withMsg, eventTypes, _options) {
        const result = this.api.v1MessageAttemptListByEndpoint(appId, endpointId, limit, iterator, status, statusCodeClass, channel, before, after, withContent, withMsg, eventTypes, _options);
        return result.toPromise();
    }
